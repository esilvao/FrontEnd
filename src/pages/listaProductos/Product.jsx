...
const Product = () => {
  ...
  // Extraer las propiedades del objeto "product" para mostrarlas en la interfaz
  const { categoria, subCategoria, SKU, producto, marca, precio, genero, talla, color, material, temporada, 
    dateUpdate, stock, bodega,} 
    = product[0];//* dejamos en posición cero el array
